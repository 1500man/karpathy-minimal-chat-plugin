...
このプラグインは、次のプロジェクトで示された考え方とガイドラインを一般チャット向けに適応したものです。

- [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills)

元プロジェクトはAndrej Karpathy氏のLLMコーディングに関する観察をもとにしたMITライセンスのガイドラインです。元プロジェクトに著作権表示がある場合は、その表示とMITライセンス本文を再配布時にも維持してください。

このプラグインの新規の適応・構成・パッケージング部分：

Copyright (c) 2026 e-com.corp.ltd
